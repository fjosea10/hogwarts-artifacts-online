...
class ArtifactControllerTest {
    ...
    void testFindArtifactByIdSuccess() throws Exception {
        // Given: Define of artifact service behavior
        given(this.artifactService.findById("1250808601736515584")).willReturn(this.artifacts.get(0));

        // When and then: invoke handler method find artifact by id by generating fake http request
        this.movkcMvc.perform(get("/api/v1/artifacts/1250808601736515584").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Find One Success"))
                .andExpect(jsonPath("$.data.id").value("1250808601736515584"))
    ...
    void testFindArtifactByIdNotFound() throws Exception {
        // Given: Define of artifact service behavior
        given(this.artifactService.findById("1250808601736515584")).willThrow(new ArtifactNotFoundException("1250808601736515584"));
